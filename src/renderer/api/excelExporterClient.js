...
const excelExporterUtils = consumer.wrapper(new ExcelExportor(), "excelExporter");

class ExcelExporterClient {
    ...
    generateExcelAndWriterFile(headers, dataList, fileName, type) {
        ...
        // 交给主进程导出
        excelExporterUtils.generateExcelAndWriterFile(headers, datas, fileName, type);
    }
}

export default new ExcelExporterClient();