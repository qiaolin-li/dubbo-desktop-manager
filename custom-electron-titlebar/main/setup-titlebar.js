    ...
    if (window) {
      switch (eventName) {
        ...
        case 'window-maximize':
          (window === null || window === void 0 ? void 0 : window.isMaximized()) ? window.unmaximize() : window === null || window === void 0 ? void 0 : window.maximize();
          break;
        case 'window-close':
          window === null || window === void 0 ? void 0 : window.close();
          break;
        case 'window-is-maximized':
          event.returnValue = window === null || window === void 0 ? void 0 : window.isMaximized();
          break;
        default:
          break;
      }
